...
filepath = "modelANN_ADASYN-" + "val_accuracy-" + str(max(history.history['val_accuracy'])) + ".png"
...
filepath = "modelANN_ADASYN-" + "val_loss-" + str(max(history.history['val_loss'])) + ".png"
...
filepath = "modelANN_ADASYN_confusion_matrix" + "val_accuracy-" + str(max(history.history['val_accuracy'])) + ".png"

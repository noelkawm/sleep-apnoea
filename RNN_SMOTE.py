...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath= 'modelRNN_SMOTE.{epoch:02d}-{accuracy:.4f}-{val_accuracy:.4f}.h5',
...
filepath = "modelRNN_SMOTE." + inttostring(history.history['val_accuracy'].index(max(history.history['va_accuracy'])) + 1) + "-"

...
logging.basicConfig(filename="logRNN_ADASYN",
                    filemode='a',
                    format='%(asctime)s,%(msecs)d %(name)s %(levelname)s %(message)s',
                    datefmt='%H:%M:%S',
                    level=logging.INFO)

logging.info("Running RNN_ADASYN.py")

logger = logging.getLogger('RNN_ADASYN')
...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath= 'modelRNN_ADASYN.{epoch:02d}-{accuracy:.4f}-{val_accuracy:.4f}.h5',
...
filepath = "modelRNN_ADASYN-" + "val_accuracy-" + str(max(history.history['val_accuracy'])) + ".png"
...
filepath = "modelRNN_ADASYN-" + "val_loss-" + str(max(history.history['val_loss'])) + ".png"
...
filepath = "modelRNN_ADASYN." + inttostring(history.history['val_accuracy'].index(max(history.history['val_accuracy'])) + 1) + "-"
...
filepath = "modelRNN_ADASYN_confusion_matrix" + "val_accuracy-" + str(max(history.history['val_accuracy'])) + ".png"
